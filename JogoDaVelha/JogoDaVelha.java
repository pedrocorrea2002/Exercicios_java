        ...
        while (status == 0) {
            ...
            do {
                ...
                if ((Tabuleiro[A - 1][B - 1] == " ") & (Player == Player1)) {
                    ...
                    System.out.println("");
                    System.out.println("Casa cheia, tente novamente");
                    Jogada = 1;
                }
            } while (Jogada == 1);
            ...
            if (
                ...
                System.out.println("");
                System.out.println("||||||| Vitôria de " + Player1 + " |||||||");
                System.out.println("");
                System.out.println("             _" + "|1|" + "2" + "|3|");
                System.out.println("             1|" + Tabuleiro[0][0] + "|" + Tabuleiro[0][1] + "|" + Tabuleiro[0][2] + "|");
                System.out.println("             2|" + Tabuleiro[1][0] + "|" + Tabuleiro[1][1] + "|" + Tabuleiro[1][2] + "|");
                ...
                for (int C = 0; C < (("_Vitôria de " + Player1).length() + 1); C++) {
                    System.out.print("|");
                }
                System.out.println("");
                ...
                System.out.println("");
                System.out.println("||||||| Vitôria de " + Player2 + " |||||||");
                System.out.println("");
                System.out.println("             _" + "|1|" + "2" + "|3|");
                System.out.println("             1|" + Tabuleiro[0][0] + "|" + Tabuleiro[0][1] + "|" + Tabuleiro[0][2] + "|");
                System.out.println("             2|" + Tabuleiro[1][0] + "|" + Tabuleiro[1][1] + "|" + Tabuleiro[1][2] + "|");
                ...
                System.out.println("");
                System.out.print("||||||||||||||");
                for (int C = 0; C < (("_Vitôria de " + Player2).length() + 1); C++) {
                    System.out.print("|");
                }
                System.out.println("");
